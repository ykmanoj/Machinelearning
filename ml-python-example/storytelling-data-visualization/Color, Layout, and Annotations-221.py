...
for sp in range(0,4):
    ...
    cb_dark_women = (0/255,107/255,164/255)
    cb_dark_men = (255/255,128/255,14/255)
    # The color for each line is assigned here.
    ax.plot(women_degrees['Year'], women_degrees[major_cats[sp]], c=cb_dark_women, label='Women')
    ax.plot(women_degrees['Year'], 100-women_degrees[major_cats[sp]], c=cb_dark_men, label='Men')
