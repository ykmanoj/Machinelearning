...
age_is_false=titanic_survival[age_is_null == False]['age']
correct_mean_age = (age_is_false.sum()) / len(age_is_false)
...
for pclass in passenger_classes:
    fares_by_class[pclass] = titanic_survival[titanic_survival['pclass']==pclass]['fare'].mean()
